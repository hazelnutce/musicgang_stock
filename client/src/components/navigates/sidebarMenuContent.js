    ...
    return (
        <ul id="slide-out" className="sidenav">
            <ul style={shiftTop30}>
                ...
                <li><Link to="/transactions" className="sidenav-close"><i><FontAwesomeIcon className="fas fa-sm" icon="arrow-up"/></i><i style={shiftLeftMinus45}><FontAwesomeIcon className="fas fa-sm" icon="arrow-down"/></i><span style={{left: "-55px" , position: "relative"}}>{"นำเข้า/นำออกสินค้า"}</span></Link></li>
                ...
                <li><Link to="/costs" className="sidenav-close"><i><FontAwesomeIcon className="fas fa-lg" icon="dollar-sign"/></i>บันทึกค่าใช้จ่าย</Link></li>
