...
export class MonthPicker extends Component {
  ...
  render() {
    return (
      <div>
        <h6>
          <div onClick={() => this.props.handleMinusMonth()} className="waves-effect waves-light btn-small btn-flat" style={{marginRight: "10px"}}>
          ...
          <div onClick={() => this.props.handleAddMonth()} className="waves-effect waves-light btn-small btn-flat" style={{marginLeft: "10px"}}>
              <i className="material-icons">
                chevron_right
              </i>
          </div>
        ...
        <div id="modal1" className="modal">
          <div className="modal-content">
            <h6>
                <div onClick={() => this.handleMonthOnModal("minus")} className="waves-effect waves-light btn-small btn-flat" style={{marginRight: "10px"}}>
                  <i className="material-icons">
                    chevron_left
                  </i>
                </div>
              {this.state.currentYear}
              <div onClick={() => this.handleMonthOnModal("add")} className="waves-effect waves-light btn-small btn-flat" style={{marginLeft: "10px"}}>
                  <i className="material-icons">
                    chevron_right
                  </i>
              </div>
