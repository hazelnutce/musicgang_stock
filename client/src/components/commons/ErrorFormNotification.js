    ...
    return (
        <div className="row">
            ...
            <span className="white-text" style={shiftErrorMessage}>
                ...
                <button className="link-button btn-flat right" style={shiftErrorMessage} onClick={() => clearErrorMessage()}><i className="close right material-icons  white-text">close</i></button>
